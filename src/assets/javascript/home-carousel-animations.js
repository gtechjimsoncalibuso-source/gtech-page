...
// We intentionally do NOT use ScrollTrigger here — carousel should not respond to page scroll.
...
export default function initCarousel() {
	...
	// if there are no cards, bail out
	...
	// No ScrollTrigger: disable scroll-driven control. We'll control playhead only
	// via buttons and dragging. `wrapTime`, `scrub` and `seamlessLoop` handle looping.
